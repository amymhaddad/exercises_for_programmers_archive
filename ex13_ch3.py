...
investment_compounded_over_time = principal_amount * (1 + (annual_interest_rate) / frequency_interest_compounded_yearly) ** frequency_interest_compounded_yearly * years_invested
