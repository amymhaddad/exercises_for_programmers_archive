...
#step3: write a line of code to change the first letter of each name using index and .replace
...
#step3: write a line of code to swap the names using a tuple
...
#step3a: add the truples together so all objects are within one truple
swapped_name = swap_firstname + swap_lastname

#step3b: index the newly formed truple to form new first and last names for one name
...
#step3c: index the newly formed truple to form new first and last names for second name
